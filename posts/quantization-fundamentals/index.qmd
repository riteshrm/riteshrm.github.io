...
description: "Introductory notes on model quantization, lower-precision data types, scaling, zero points, and model compression basics."
---
...
2. Knowledge Distillation:- Train a smaller model(Student) using the original model(Teacher). Cons:-You need to have enough hardware to fit both teacher as well student both.
