...
- This is mostly based on:
    1. [Stanford CME296 Diffusion & Large Vision Models | Spring 2026 | Lecture 1 - Diffusion](https://www.youtube.com/watch?v=tr-CUpw--ck)
    2. [Diffusion Models | Paper Explanation | Math Explained](https://www.youtube.com/watch?v=HoKDTa5jHvg&t=1409s)
...
<figure style="text-align: center;">
  <img src="ddpm.gif" style="width:60%">
  <figcaption>DDPM samples from epoch 0 through training</figcaption>
</figure>
...
<figure style="text-align: center;">
  <img src="ddim.gif" style="width:60%">
  <figcaption>DDIM samples from epoch 0 through training</figcaption>
</figure>
