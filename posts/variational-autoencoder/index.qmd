...
- This is mostly based on:
    1. [Understanding Variational Autoencoder](https://www.youtube.com/watch?v=1RPdu_5FCfk)
    2. [Variational Autoencoder - Model, ELBO, loss function and maths explained easily](https://www.youtube.com/watch?v=iwEzwTTalbg)
:::

---

- Minimal PyTorch implementation accompanying these notes:
  - [vae GitHub Repo](https://github.com/riteshrm/vae)
